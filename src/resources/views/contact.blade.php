        ...
        <form action="/confirm" method="post">
            ...
            <div class="contact-form__group">
                ...
                <div class="contact-form__gender-inputs">
                    ...
                    <div class="contact-form__gender-option">
                        <label class="contact-form__gender-label">
                            <input class="contact-form__gender-input" name="gender" type="radio" id="female" value="2" {{ old('gender')==2 ? 'checked' : '' }}>
                            <span class="contact-form__gender-text">女性</span>
                        </label>
                    </div>
                    <div class="contact-form__gender-option">
                        <label class="contact-form__gender-label" for="other">
                            <input class="contact-form__gender-input" name="gender" type="radio" id="other" value="3" {{ old('gender')==3 ? 'checked' : '' }}>
            ...
            <div class="contact-form__group">
                ...
                <input class="contact-form__input" type="text" name="email" id="email" value="{{ old('email') }}" placeholder="例：test@example.com">
                <p class="contact-form__error-message">
                    @error('email')
                    {{ $message }}
                    @enderror
